...
<form method="post" action="${pageContext.request.contextPath }/adminuser_login.action" target="_parent" name='theForm' ">
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <tr>
        <td colspan="2" align="right">&raquo; <a href="${pageContext.request.contextPath }" style="color:white">返回首页</a> &raquo; <a href="get_password.php?act=forget_pwd" style="color:white">您忘记了密码吗?</a></td>
      </tr>
