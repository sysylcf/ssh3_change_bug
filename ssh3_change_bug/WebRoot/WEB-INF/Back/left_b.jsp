...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('0102','01','一级分类管理','','','mainFrame');
		 ...
		 d.add('010201','0102','一级分类管理','${pageContext.request.contextPath}/adminCategory_findAllByOne.action','','mainFrame'); 
		...
		d.add('010301','0103','二级分类管理','${pageContext.request.contextPath}/adminCategorySecond_findSecond.action','','mainFrame');
		d.add('0104','01','商品管理','','','mainFrame');
		d.add('010401','0104','商品管理','${pageContext.request.contextPath}/adminProduct_index.action','','mainFrame');
