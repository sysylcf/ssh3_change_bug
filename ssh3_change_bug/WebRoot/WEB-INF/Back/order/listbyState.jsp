            ...
            <tr  >
                ...
                <td valign="top" background="${pageContext.request.contextPath}/Images_rm/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="./${pageContext.request.contextPath}/Images_rm/content_bg.gif">
                        <tr><td height="31"><div class="title">&nbsp;&nbsp;&nbsp;&nbsp;订单</div></td></tr>
                    </table>
                </td>
					...
					<tr align="center">
						<td colspan="7">
							...
							<s:if test="pageBean.page != 1">
								<a href="${ pageContext.request.contextPath }/adminOrder_findAllByState.action?page=1&states=<s:property value='states'/>">首页</a>|
								<a href="${ pageContext.request.contextPath }/adminOrder_findAllByState.action?page=<s:property value="pageBean.page-1"/>&states=<s:property value="states"/>">上一页</a>|
							</s:if>
							
							<s:if test="pageBean.page != pageBean.totalPage">
								<a href="${ pageContext.request.contextPath }/adminOrder_findAllByState.action?page=<s:property value="pageBean.page+1"/>&states=<s:property value="states"/>"/>">下一页</a>|
								<a href="${ pageContext.request.contextPath }/adminOrder_findAllByState.action?page=<s:property value="pageBean.totalPage"/>&states=<s:property value="states"/>">尾页</a>|
							</s:if>
						</td>
					</tr>
				</TBODY>
