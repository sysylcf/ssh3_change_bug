...
<HTML>
	<HEAD>
		...
		function onReset() {
			...
			alert(select2);
			location.reload();
			document.getElementById("doubleselect").setAttribute("value", 3); */
			 window.open("adminProduct_edit.action?pid="+pid, ""); 
		}
	...
	<body>
		...
		<%-- <form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct_update.action" method="post" enctype="multipart/form-data"> --%>
			<s:form id="userAction_save_do"  name="Form1" action="adminProduct_update.action"  >
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						...
						<s:doubleselect id="select" name="Category.cid" list="cList"
								listKey="cid" 
								listValue="cname" label="要管理的分类"
								value="cid" theme="simple"
								doubleList="sMap[cid]" 
								doubleName="categorySecond.csid" 
								doubleId="doubleselect" 
								doubleListKey="csid"
								doubleListValue="csname"
								
								/>
							<!-- 	 doubleCssStyle="width:132px; margin-top:10px; margin-left:84px"  -->
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<!-- <button type="reset" value="重置" class="button_cancel">&#37325;&#32622;</button> -->
                                                                                                     <button  value="重置" class="button_cancel" onclick="onReset();">&#37325;&#32622;</button>
						<FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
