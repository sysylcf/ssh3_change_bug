...
<div class="headerAd">
	...
	<div class="adbackg" style="background-color:#666666; margin-top: 100px; "> 
	<%-- 	<div class="span12" style="width: 200px ;float: right;" >
			<div class="ad">
					<img src="${pageContext.request.contextPath}/image/login.jpg" width="500" height="330" alt="会员登录" title="会员登录">
			</div>	
		</div> --%>
		<div class="span12 last" style="margin-left: 200px" >
			<div class="wrap">
				<div class="main">
					<div class="title">
