	...
	<div class="span5">
		<div class="logo">
			<a href="${pageContext.request.contextPath}/index">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.jpg" alt="lcf">
			</a>
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
	...
	<%@ include file="right_tools.jsp" %>
	
</div>	
<!--搜索框  -->
	<%-- <div class="hotProduct" style="float:right;">
