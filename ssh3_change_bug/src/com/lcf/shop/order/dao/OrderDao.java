package com.lcf.shop.order.dao;
...
public class OrderDao extends HibernateDaoSupport {
	...
	//Dao中根据状态分页查询订单的方法
public List<Order> findByPageByState(int begin, int limit, int state) {
	String hql = "from Order o where o.state="+state+" order by ordertime desc";
	List<Order> list = this.getHibernateTemplate().execute(
			new PageHibernateCallback<Order>(hql, null, begin, limit));
	return list;
	}
